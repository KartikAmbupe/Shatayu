                ...
                <div className="mt-8 overflow-hidden">
                    <div className="grid grid-cols-1 md:grid-cols-2">
                        ...
                        <form className="p-6 flex flex-col justify-center">
                            ...
                            <button
                                type="submit"
                                className="text-white md:w-32 bg-orange-600 hover:bg-blue-dark textWhite font-bold py-3 px-6 roundedLg mt-3 hover:bg-orange-400 rounded-lg transition ease-in-out duration-300"
                            >
                                Submit
                            </button>
                        </form>
